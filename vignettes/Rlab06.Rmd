...
For brute_force_knapsack(), delete rows reduces the n in \\(2^n\\), which decreases the running time significantly. 

In knapsack_dynamic(), the time slightly improves. 

However, this way does not working in greedy funciton. In contrast, the time increases.
